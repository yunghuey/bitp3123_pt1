 ...
 * @author yung huey
 */
public class TextFrameClient extends JFrame {
	...
	/***
	 * This method update the value of number on the frame
	 * @param number of text
	 */
	public void updateText(String textnum) {
		this.lblServerDate.setText(textnum);
	}
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblDate = new JLabel ("Number (from Server): ");
